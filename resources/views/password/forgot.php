<header class="mb-6 text-center">
    ...
    <p class="mt-2 text-sm text-slate-500">Enter your email address and we'll send you a code to reset your password.</p>
</header>
...
<form method="post" class="space-y-4">
    ...
    <button type="submit" class="w-full rounded bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-500">Send reset code</button>
</form>

<p class="mt-6 text-center text-sm text-slate-500">
    Remembered your password? <a href="/oauth2/authorize" class="text-indigo-600 hover:text-indigo-500">Return to login</a>
</p>
